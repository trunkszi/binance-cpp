...
const prices_t::price_t&
prices_t::get_by_symbol(const char *sym) const {
...
const account_info_t::balance_t&
account_info_t::get_balance(const char *symbol) const {
...
new_order_resp_type
new_order_resp_type::construct(const flatjson::fjson &json) {
    assert(json.is_valid());
